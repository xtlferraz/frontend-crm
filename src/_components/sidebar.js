      ...
      <SidebarContainer>
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            ...
            <SidebarMenuItemLabel>Pessoa Física</SidebarMenuItemLabel>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <Icon viewBox="0 0 20 20">
              <path
            ...
            <SidebarMenuItemLabel>Pessoa Jurídica</SidebarMenuItemLabel>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <Icon viewBox="0 0 20 20">
              <path
          ...
          <SidebarMenuItem>
            ...
            <SidebarMenuItemLabel>Produtos</SidebarMenuItemLabel>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <Icon viewBox="0 0 20 20">
              <path
            ...
            <SidebarMenuItemLabel>Eventos</SidebarMenuItemLabel>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <Icon viewBox="0 0 20 20">
              <path
            ...
            <SidebarMenuItemLabel>Equipes</SidebarMenuItemLabel>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <Icon viewBox="0 0 20 20">
              <path
            ...
            <SidebarMenuItemLabel>Usuários</SidebarMenuItemLabel>
          </SidebarMenuItem>
          <MenuSignOut>
